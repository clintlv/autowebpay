...
| billFirstName | string   | 是   | 姓                                   |
| billLastName  | string   | 是   | 名                                   |
| billAddress   | string   | 是   | 地址                                  |
| billCity      | string   | 是   | 城市                                  |
| billState     | string   | 是   | 州/省                                 |
| billCountry   | string   | 是   | 国家                                  |
| billZip       | string   | 是   | 邮编                                  |
| billEmail     | string   | 是   | 邮箱                                  |
| billPhone     | string   | 是   | 电话                                  |
| ip            | string   | 是   | IP地址                                |
...
| 卡类型         | 卡号                   |
|-------------|----------------------|
| MasterCard  | 5121 2121 2121 2124  |
